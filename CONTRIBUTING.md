...
`pnpm package:check` verifies that the executable and all skills are shipped
together. Skill validation checks frontmatter, reference reachability, and
example commands against the actual parser. A release must not publish a CLI
