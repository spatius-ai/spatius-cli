/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4a23477542a04f731e335cd6542b4389)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	STUDIO_API_URL: "https://api.studio.spatius.ai";
	PUBLIC_URL: "https://spatius-cli-media-staging.472617147.workers.dev" | "https://cli-media.spatius.ai" | "http://localhost:8787";
	SIGNING_KEY_ID: "v1";
	MAX_STORED_BYTES: "2147483648";
	MAX_UPLOADS_PER_DAY: "100";
	MAX_UNFINISHED_UPLOADS: "10";
	REQUESTS_PER_SECOND: "10";
	REQUEST_BURST: "20";
	UPLOADS: DurableObjectNamespace<import("./src/index").UploadCoordinator>;
	SIGNING_KEYS?: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UploadCoordinator";
	}
	interface StagingEnv {
		MEDIA_BUCKET: R2Bucket;
		STUDIO_API_URL: "https://api.studio.spatius.ai";
		PUBLIC_URL: "https://spatius-cli-media-staging.472617147.workers.dev";
		SIGNING_KEY_ID: "v1";
		MAX_STORED_BYTES: "2147483648";
		MAX_UPLOADS_PER_DAY: "100";
		MAX_UNFINISHED_UPLOADS: "10";
	...
	interface ProductionEnv {
		MEDIA_BUCKET: R2Bucket;
		STUDIO_API_URL: "https://api.studio.spatius.ai";
		PUBLIC_URL: "https://cli-media.spatius.ai";
		SIGNING_KEY_ID: "v1";
		MAX_STORED_BYTES: "2147483648";
		MAX_UPLOADS_PER_DAY: "100";
		MAX_UNFINISHED_UPLOADS: "10";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STUDIO_API_URL" | "PUBLIC_URL" | "SIGNING_KEY_ID" | "MAX_STORED_BYTES" | "MAX_UPLOADS_PER_DAY" | "MAX_UNFINISHED_UPLOADS" | "REQUESTS_PER_SECOND" | "REQUEST_BURST" | "SIGNING_KEYS">> {}
}
